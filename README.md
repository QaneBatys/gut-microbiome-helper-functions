...
- pipeline: contains ml code;
- data: contains original data and modified data from original;
- reports: results from the running the scripts;

! It is important to note that all folders have readme.md file to explain in more details. 
